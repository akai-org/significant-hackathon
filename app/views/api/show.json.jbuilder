...
json.Elements @task.elements.sort_by(&:layer) do |element|
  ...
  json.imageAfterAnimationUrl "https://s3.eu-central-1.amazonaws.com/looks-tasty" + element.image_after_animation.path if element.image_after_animation.present?
end
